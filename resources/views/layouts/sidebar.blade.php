<div id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center 
           ...
           aria-expanded="{{ request()->is('obat/*') ? 'true' : 'false' }}"
           aria-controls="submenuObat">
        ...
        {{-- Poliklinik --}}
        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center 
           {{ request()->is('dashboard/poli*') ? 'active' : '' }}"
        ...
        {{-- Laboratorium --}}
        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center
           {{ request()->is('dashboard/labor-*') ? 'active' : '' }}"
           data-bs-toggle="collapse" href="#submenuLabor" role="button"
           aria-expanded="{{ request()->is('dashboard/labor-*') ? 'true' : 'false' }}"
        ...
        {{-- Radiologi --}}
        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center
           {{ request()->is('dashboard/radiologi-*') ? 'active' : '' }}"
        ...
        {{-- Pasien --}}
        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center
           {{ request()->is('dashboard/pasien-*') ? 'active' : '' }}"
           data-bs-toggle="collapse" href="#submenuPasien" role="button"
           aria-expanded="{{ request()->is('dashboard/pasien-*') ? 'true' : 'false' }}"
        ...
        {{-- Klaim --}}
        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center 
           {{ request()->is('pengajuan-claim-*') ? 'active' : '' }}"
           data-bs-toggle="collapse" href="#submenuKlaim" role="button"
           aria-expanded="{{ request()->is('pengajuan-claim-*') ? 'true' : 'false' }}"
        ...
        {{-- Kamar --}}
        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center 
           {{ request()->routeIs('kamar.*') ? 'active' : '' }}"
           data-bs-toggle="collapse" href="#submenuKamar" role="button"
           aria-expanded="{{ request()->routeIs('kamar.*') ? 'true' : 'false' }}"
        ...
        <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center 
           {{ request()->routeIs('dokter.*') ? 'active' : '' }}"
           data-bs-toggle="collapse" href="#submenuDokter" role="button"
           aria-expanded="{{ request()->routeIs('dokter.*') ? 'true' : 'false' }}"
