...
@section('title', 'Grafik Kunjungan Lab Rawat Inap')

@section('content')
<div class="container py-4">
    <h2 class="mb-4 text-center">
        <i class="bi bi-bar-chart-line-fill me-2"></i>Grafik Kunjungan Lab Rawat Inap
    </h2>
...
function createApexChart(data) {
    ...
    const options = {
        ...
        colors: ['#FF9D23'], // base warna biru
        fill: {
            type: 'gradient',
            gradient: {
                shade: 'dark',
                type: 'vertical', // tetap vertikal
                gradientToColors: ['#F3C623'], // gradasi ke putih
                shadeIntensity: 0.5,
                opacityFrom: 0.9,
                opacityTo: 0.7,
                stops: [0, 100]
        ...
        plotOptions: {
            bar: {
                horizontal: false,
                columnWidth: '50%',
                borderRadius: 3 // sudut membulat
            }
        },
        dataLabels: {
            enabled: true,
            style: {
                colors: ['#fefce8'], // teks kontras
                fontSize: '12px'
            }
        },
        xaxis: {
