  ...
  <div class="container-fluid">
    ...
    <div class="card card-danger card-outline">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modalTambah">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Chart Pengeluaran - Area Chart (Red Theme)
  var options = {
    series: [{
      name: 'Pengeluaran',
  ...
  var chart = new ApexCharts(document.querySelector("#chart-pengeluaran"), options);
  chart.render();
});
</script>
@endsection