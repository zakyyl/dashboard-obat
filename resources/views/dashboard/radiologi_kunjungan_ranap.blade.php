...
@section('title', 'Grafik Kunjungan Radiologi Rawat Inap')

@section('content')
    <div class="container py-4">
        <h2 class="mb-4 text-center">
            <i class="bi bi-bar-chart-line-fill me-2"></i>Grafik Kunjungan Radiologi Rawat Inap
        </h2>
        ...
        function createApexChart(data) {
            ...
            const options = {
                ...
                xaxis: {
                    ...
                    title: {
                        text: 'Kunjungan Radiologi Ranap',
                        style: {
